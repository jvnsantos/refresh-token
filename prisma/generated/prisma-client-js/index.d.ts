...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    username?: boolean
    password?: boolean
    refresh_token?: boolean | RefreshTokenArgs
  }
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'refresh_token' ? RefreshTokenGetPayload<S['include'][P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'refresh_token' ? RefreshTokenGetPayload<S['select'][P]> | null :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    refresh_token<T extends RefreshTokenArgs = {}>(args?: Subset<T, RefreshTokenArgs>): CheckSelect<T, Prisma__RefreshTokenClient<RefreshToken | null >, Prisma__RefreshTokenClient<RefreshTokenGetPayload<T> | null >>;
  ...
  export type UserWhereInput = {
    ...
    refresh_token?: XOR<RefreshTokenRelationFilter, RefreshTokenWhereInput> | null
  }
